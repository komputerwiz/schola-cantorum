...
\heading{Miserere Mei}

\begin{rubric}
  Choir stand.
\end{rubric}

\include{04-miserere-mei.gabc}

\begin{rubric}
  The fifth candle is extinguished.
\end{rubric}

\heading{A reading from the 42nd Chapter of Isaiah}
...
\heading{A Reading from the 3rd Chapter of Lamentations}
...
\heading{A reading from the 5th Chapter of Lamentations}
...
\heading{Parce Domine}

\begin{rubric}
  Choir stand.
\end{rubric}

\include{07-parce-domine.gabc}

\begin{rubric}
  The eleventh candle is extinguished.
\end{rubric}

\heading{Canticle of the Suffering Servant (Isaiah 52, 53)}
